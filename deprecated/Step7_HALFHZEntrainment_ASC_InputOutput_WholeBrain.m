...
% stimFreqMedian=stimFreqMedian_new;    
...
%             end
    ...
    'chanLabels', 'v_FreqAxis', 'v_TimeAxis', 'parFFT','RemovedFreqs','rem_train_nums','original_f_order');
end
